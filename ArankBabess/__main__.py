...
import ArankBabess.modules.sql.users_sql as sql
from ArankBabess import (
    BOT_NAME,
    BOT_USERNAME,
    LOGGER,
    OWNER_ID,
...
from ArankBabess.modules import ALL_MODULES
from ArankBabess.modules.helper_funcs.chat_status import is_user_admin
from ArankBabess.modules.helper_funcs.misc import paginate_modules
...
🌹Heyy everyone!! I guess mujhe apna intro dene ki need toh nhi nam toh suna he hoga chalo jokes apart let me tell you who I'm.I'm Arank...my functions are managing your chats,let you listen all your favourite songs,control the access of your chats.
Thankyou so much it's all about me!❤️ 🌷
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="🌷𝐆𝐑𝐎𝐔𝐏🌷", url=f"https://t.me/Carding_Chronicle"),
        InlineKeyboardButton(text="🏡𝐎𝐅𝐅𝐈𝐂𝐄🏡", url=f"https://t.me/Itsz_Arank_Babess"),
    ],
    [
        InlineKeyboardButton(text="🌱𝐒𝐎𝐔𝐑𝐂𝐄🌱", callback_data="arank_"),
    ],
]
...
ʏᴏᴜ ᴄᴀɴ ᴅɪʀᴇᴄᴛʟʏ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [ᴅᴇᴠᴇʟᴏᴩᴇʀ](f"tg://user?id={1195997736}") ғᴏʀ ᴅᴏɴᴀᴛɪɴɢ ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴠɪsɪᴛ ᴍʏ [sᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ](f"https://t.me/Carding_Chronicle") ᴀɴᴅ ᴀsᴋ ᴛʜᴇʀᴇ ᴀʙᴏᴜᴛ ᴅᴏɴᴀᴛɪᴏɴ."""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("ArankBabess.modules." + module_name)
...
@run_async
def arank_about_callback(update: Update, context: CallbackContext):
    query = update.callback_query
    if query.data == "arank_":
        uptime = get_readable_time((time.time() - StartTime))
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="📍𝐎𝐖𝐍𝐄𝐑📍", url=f"https://t.me/Itsz_Arank_Babess"
                        ),
                        InlineKeyboardButton(
                            text="🎄𝐑𝐄𝐏𝐎🎄", 
                            url="https://github.com/CodeXKrishna/ArankBabess",
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="✯ вαϲк ✯", callback_data="arank_back"),
                    ],
                ]
            ),
        )
    elif query.data == "arank_back":
        first_name = update.effective_user.first_name 
        query.message.edit_text(
            PM_START_TEXT.format(escape_markdown(first_name), (START_IMG), BOT_NAME),
            reply_markup=InlineKeyboardMarkup(buttons),
...
☆............𝙱𝚈 » [Itsz Arank](https://t.me/Itsz_Arank_Babess)............☆
""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != {OWNER_ID} and DONATION_LINK:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs [Arank](https://t.me/Itsz_Arank_Babess)"
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendAnimation(
                f"@{SUPPORT_CHAT}",
                animation="https://telegra.ph/file/a54767f825a665a136aa3.mp4",
                caption=f"""
{dispatcher.bot.first_name}

╔═════ஜ۩۞۩ஜ═════╗

  ♨️𝗠𝗔𝗗𝗘 𝗕𝗬 [Arank](https://t.me/Itsz_Arank_Babess)♨️
...
""",
    ...
    about_callback_handler = CallbackQueryHandler(
        arank_about_callback, pattern=r"arank_"
    )
