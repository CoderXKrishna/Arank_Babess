...
# from ArankBabess.modules.sql import warns_sql as warnssql
import ArankBabess.modules.sql.blacklist_sql as blacklistsql

# from ArankBabess.modules.sql import cust_filters_sql as filtersql
# import ArankBabess.modules.sql.welcome_sql as welcsql
import ArankBabess.modules.sql.locks_sql as locksql
import ArankBabess.modules.sql.notes_sql as sql

# from ArankBabess.modules.rules import get_rules
import ArankBabess.modules.sql.rules_sql as rulessql
from ArankBabess import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from ArankBabess.__main__ import DATA_IMPORT
from ArankBabess.modules.connection import connected
from ArankBabess.modules.helper_funcs.alternate import typing_action
from ArankBabess.modules.helper_funcs.chat_status import user_admin
from ArankBabess.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("ArankBabess{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("ArankBabess{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `ArankBabess-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("ArankBabess{}.backup".format(chat_id))  # Cleaning file
