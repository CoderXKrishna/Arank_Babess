...
import ArankBabess
import ArankBabess.modules.sql.welcome_sql as sql
...
from ArankBabess.modules.helper_funcs.misc import build_keyboard, revert_buttons
from ArankBabess.modules.helper_funcs.msg_types import get_welcome_type
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                if not ArankBabess.ALLOW_CHATS:
...
from ArankBabess import BOT_NAME
from ArankBabess import pbot as app
OWNERs_ID=1195997736
@app.on_message(
