...
import ArankBabess.modules.sql.chatbot_sql as sql
from ArankBabess import BOT_ID, BOT_NAME, BOT_USERNAME, dispatcher
from ArankBabess.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from ArankBabess.modules.log_channel import gloggable
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        url = f"https://kora-api.vercel.app/chatbot/2d94e37d-937f-4d28-9196-bd5552cac68b/Itsz_Arank_Babes_Bot/Anonymous/message={message.text}"
...
__help__ = f"""
*@Itsz_Arank_Babes_Bot ʜᴀs ᴀɴ ᴄʜᴀᴛʙᴏᴛ ᴡʜɪᴄʜ  ᴘʀᴏᴠɪᴅᴇs ʏᴏᴜ ᴀ sᴇᴇᴍɪɴɢʟᴇss ᴄʜᴀᴛᴛɪɴɢ ᴇxᴘᴇʀɪᴇɴᴄᴇ :*
